...
quit () {
	...
	echo "  -s   SERVER_HOME -  path jboss home: ex.: c:\\temp\\$APPL_SERVER.1.Final\\."
...
cp -r "$LAU_BUNDLE/modules/codes" "$SERVER_HOME/modules/"

# this is temporarily  to use latest and the greatest xmlsec and wss4j
# rm -rf "$SERVER_HOME/modules/system/layers/base/org/apache/santuario"
# mv "$SERVER_HOME/modules/org/apache/santuario" "$SERVER_HOME/modules/system/layers/base/org/apache/"

# rm -rf "$SERVER_HOME/modules/system/layers/base/org/apache/ws/security"
#ls -ltr "$SERVER_HOME/modules/org/apache/ws/security"
# mv "$LAU_BUNDLE/modules/org/apache/ws/security" "$SERVER_HOME/modules/system/layers/base/org/apache/ws/"
...
# application plugins
# TODO  deployment of the plugins
