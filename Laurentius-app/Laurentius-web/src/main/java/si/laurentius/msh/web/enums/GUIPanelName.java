...
public enum GUIPanelName {
    ...
    GUIPanelName(String code, int groupIndex) {
        this.mstrCode = code;
    ...
    // get by Group index
    public static GUIPanelName getByGroupIndex(int groupIndex) {
        for (GUIPanelName panel : GUIPanelName.values()) {
            if (panel.getGroupIndex() == groupIndex) {
                return panel;
            }
        }
        return null;
