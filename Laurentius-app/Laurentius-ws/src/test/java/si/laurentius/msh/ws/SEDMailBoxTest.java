...
import si.laurentius.msh.ws.utils.InitialContextFactoryForTest;
import si.laurentius.msh.ws.utils.MockJMS;
...
//      assertEquals("Sender box", om.getSenderEBox(), mer.getRData().getOutEvent().getSenderEBox());
    ...
    private InMail createInMail() {
        ...
        im.setMessageId("SM_ID-" + UUID.randomUUID());
        im.setSenderMessageId(im.getMessageId());
        im.setAction("action");
    ...
    private OutMail createOutMail() {
        ...
        om.setMessageId("SM_ID-" + UUID.randomUUID());
        om.setSenderMessageId(om.getMessageId());
...
//        mevent.setSenderEBox(mail.getSenderEBox());
    ...
    public void test_E_GetOutMailEventList() throws Exception {
        ...
        // retrieve mail events by id
        omer.getData().setMailId(BigInteger.ONE);
        omer.getData().setSenderEBox(om.getSenderEBox());
    ...
    public void test_F_GetInMailList() throws Exception {
        ...
        im2.setSenderEBox(UUID.randomUUID() + "@test-sed.si");
    ...
    public void test_G_GetInMailEventList() throws Exception {
        ...
        assertNotNull("Response/RControl/@StartIndex", mer.getRControl().
                getStartIndex());
        assertNotNull("Response/RData", mer.getRData());
        assertEquals("Response/RControl/@resultSize -> InMailEvent().size()", mer.
                getRData()
        ...
        assertEquals("Response/RControl/@resultSize -> InMailEvent().size()", mer.
                ...
                intValue());
        assertTrue("Response/RControl/@resultSize -> InMailEvent().size()", mer.
                getRData()
                .getInEvents().size() > 0);
