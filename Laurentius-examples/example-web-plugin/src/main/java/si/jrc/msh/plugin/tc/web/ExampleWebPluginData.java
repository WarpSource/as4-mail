 ...
 */
@SessionScoped
@Named("exampleWebPluginData")
public class ExampleWebPluginData implements Serializable{

  private static final SEDLogger LOG = new SEDLogger(ExampleWebPluginData.class);
