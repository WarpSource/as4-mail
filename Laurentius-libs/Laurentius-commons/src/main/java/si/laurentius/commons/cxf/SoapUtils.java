...
public class SoapUtils {
    ...
    public static void setMSHOutnMail(MSHOutMail omail, jakarta.xml.ws.Dispatch client) {
    ...
    public static void setEBMSMessageOutContext(EBMSMessageContext emc, jakarta.xml.ws.Dispatch client) {
